...
import { apiAutoImportPath } from "./src/loader/apiAutoImport"
...
const componentSrc = path.resolve(__dirname, "src/components");
  ...
  return {
    ...
    plugins: [
      ...
      AutoImport({
        ...
        dirs: ['src/components', 'src/hooks', 'src/enums', 'src/utils', 'src/interface', ...apiAutoImportPath],
        resolvers: [
